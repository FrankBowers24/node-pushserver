...
function sendNotifications(notifs) {
    console.log('Send Notifications: ', JSON.stringify(notifs, null, '\t'));
...
exports.start = function () {
    var port = process.env.PORT || config.get('webPort')
    console.log('mongo url: ', config.get('mongodbUrl'));
    console.log('gcm api key: ', config.get('gcm').apiKey);
    app.listen(port);
